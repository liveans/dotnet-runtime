...
nw_connection_t AppleNetNative_NwCreateClientContext(void)
{
    ...
    nw_endpoint_t ep = nw_endpoint_create_host("127.0.0.1", "42");
    return nw_connection_create(ep, params);
}
...
int32_t AppleNetNative_NwInit(SslStatusUpdateFunc statusFunc, SSLReadFunc readFunc, SSLWriteFunc writeFunc)
{
